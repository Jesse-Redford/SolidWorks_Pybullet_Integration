# Solidworks Pybullet Tutorial

### Description
A development guide for building custom robot assemblies in Solidworks, importing them to pybullet environment, and setting up position and speed controllers. To get started I recommend downloading the Test_Files folder. This includes a simple solidworks model and the urdf I will be refferencing for this tutorial.
